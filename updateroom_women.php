...
// คำสั่ง SQL สำหรับอัปเดตค่า ButtonStatus ในฐานข้อมูล
$sql = "UPDATE room SET ButtonStatusRoom = $newStatus WHERE dormid = 5 AND roomcode = $roomcode";

// ทำการอัปเดตค่า ButtonStatus
